  ...
  const handlePaymentMethod = (method: string) => {
    ...
    switch(method) {
      case 'Credit/Debit Card':
        // Redirect to Stripe or other card processor
      ...
      case 'PayPal':
        ...
        break;
      case 'Bank Transfer':
        // Show bank transfer details or redirect to bank transfer page
        alert('Bank Transfer Details:\n\nBank: [Your Bank Name]\nAccount Name: Masjid Salman al Farsi\nAccount Number: [Account Number]\nRouting Number: [Routing Number]\n\nPlease include your name and "donation" in the memo.');
        break;
    }
  };
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 to-white">
      ...
      <section className="relative h-[60vh] overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-center h-full">
          <div className="text-center text-white px-4">
            <h1 className="text-4xl md:text-6xl font-bold mb-6" style={{ fontFamily: 'var(--font-philosopher)' }}>
              Support Our Masjid
            </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              <div className="bg-white rounded-2xl shadow-xl p-8">
                <h2 className="text-2xl font-bold text-slate-800 mb-6" style={{ fontFamily: 'var(--font-philosopher)' }}>
                  Make Your Donation
                </h2>
                ...
                {/* Payment Method */}
                <div id="payment" className={`mb-6 transition-all duration-500 ${highlightPayment ? 'ring-4 ring-amber-400 ring-opacity-50 bg-amber-50 rounded-lg p-6 -m-2' : ''}`}>
                ...
                <div className="mt-8">
                  <button
                    ...
                    className="w-full text-center btn btn-primary icon-right relative inline-flex items-center justify-center px-4 py-2 md:px-6 md:py-2 lg:px-6 lg:py-3 border-4 border-[#8C7C4E] bg-[#8C7C4E] text-white font-bold text-sm md:text-base lg:text-lg lg:text-xl rounded-lg transition-all duration-300 ease-in-out group overflow-hidden my-2 hover:bg-transparent hover:text-black"
                  >
            ...
            <div className="space-y-8">
              ...
              <div className="bg-amber-50 rounded-2xl p-8">
                <h3 className="text-2xl font-bold text-amber-800 mb-4" style={{ fontFamily: 'var(--font-philosopher)' }}>
                  Your Impact
                </h3>
              ...
              {/* Current Campaigns */}
              <div className="bg-white rounded-2xl shadow-xl p-8">
                <h3 className="text-2xl font-bold text-slate-800 mb-4" style={{ fontFamily: 'var(--font-philosopher)' }}>
                  Current Campaigns
                </h3>
      ...
      <section className="py-16 px-4 bg-slate-50">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center text-slate-800 mb-12" style={{ fontFamily: 'var(--font-philosopher)' }}>
