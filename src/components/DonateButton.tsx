...
const DonateButton: React.FC<DonateButtonProps> = ({ 
  ...
  const baseClasses = "btn btn-primary icon-right relative inline-flex items-center justify-center px-4 py-2 md:px-6 md:py-2 lg:px-6 lg:py-3 border-4 border-[#8C7C4E] bg-[#8C7C4E] text-white font-bold text-sm md:text-base lg:text-lg lg:text-xl rounded-lg transition-all duration-300 ease-in-out group overflow-hidden my-2";
